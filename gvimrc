...
if has('win32')
  " Windows用
  set guifont=Myrica_M:h11:cSHIFTJIS:qDRAFT
...
if has('multi_byte_ime') || has('xim')
  ...
  " 挿入モードでのIME状態を記憶させない場合、次行のコメントを解除z
...
" 個人設定
" undo保存先ディレクトリ
set undodir=C:/Users/takayuki.mori/vim74-kaoriya-win32/undo/
